...
const string matchFile = "data/matches/div1.csv";
const string standingsFile = "data/standings/div1.csv";
...
void importAndGen(){
    ifstream input;
    input.open("data/divisions/div1.txt");
    noTeams = 20; //always 20
    noPromoted = 1; //single champion
    noRelegated = 3; //three relegations to division 2
...
void processPRs(){
    ...
    print << "\n";
    print.close();
    print.open("data/divisions/div1.txt");
    for(int i = 0; i < noTeams; i++){
